...
**PwnBin**	 is a webcrawler which searches public pastebins for specified keywords. All pastes are 
...
**Skiptracer**	 utilizes some basic python webscraping (BeautifulSoup) of PII paywall sites to compile 
